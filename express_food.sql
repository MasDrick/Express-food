...
--
-- Хост: 127.0.0.1
-- Время создания: Май 25 2025 г., 18:33
...
--
-- Структура таблицы `courier_deliveries`
--
...
--
-- Дамп данных таблицы `courier_deliveries`
--

INSERT INTO `courier_deliveries` (`id`, `order_id`, `courier_id`, `status`, `assigned_at`, `completed_at`, `delivery_notes`) VALUES
(1, 25, 23, 'completed', '2025-05-25 14:52:25', '2025-05-25 15:01:05', NULL),
(2, 24, 23, 'completed', '2025-05-25 14:53:05', '2025-05-25 15:00:56', NULL),
(3, 23, 23, 'completed', '2025-05-25 15:02:14', '2025-05-25 15:02:38', NULL),
(4, 22, 23, 'completed', '2025-05-25 15:11:20', '2025-05-25 15:11:23', NULL),
(5, 21, 23, 'assigned', '2025-05-25 16:20:45', NULL, NULL),
(6, 25, 23, 'assigned', '2025-05-25 16:24:59', NULL, NULL);
...
CREATE TABLE `orders` (
  ...
  `status` enum('pending','processing','transferring','delivering','completed','cancelled') NOT NULL DEFAULT 'pending',
...
INSERT INTO `orders` (`id`, `user_id`, `total_amount`, `delivery_fee`, `status`, `address`, `phone`, `created_at`, `updated_at`, `comment`, `cooking_status`, `courier_id`) VALUES
(15, 20, 1650.00, 150.00, 'completed', 'Пермь, Клары Цеткин 25', '+7 (982) 258-52-23', '2025-02-05 04:36:19', '2025-05-09 18:19:50', 'Домофон не работает, пожалуйста, позвоните!', 'not_started', NULL),
(16, 20, 1500.00, 150.00, 'completed', 'Пермь, Клары Цеткин 25', '+7 (982) 258-52-23', '2025-03-12 04:53:36', '2025-05-09 18:19:52', 'ljvjajy yt hj,bn ,kznmфыва', 'not_started', NULL),
(17, 20, 1500.00, 150.00, 'cancelled', 'Пермь, Клары Цеткин 25', '+7 (982) 258-52-23', '2025-03-20 04:54:55', '2025-05-09 18:19:53', 'ljvjajy yt hj,bn ,kznmфыва', 'not_started', NULL),
(18, 20, 9700.00, 150.00, 'cancelled', 'Лоскутова 20', '+7 (982) 258-52-23', '2025-03-21 05:34:18', '2025-05-09 18:19:55', 'Домофон ен работает', 'not_started', NULL),
(19, 20, 1500.00, 150.00, 'delivering', 'Пермь, Клары Цеткин 25', '+7 (982) 258-52-23', '2025-04-09 05:46:25', '2025-05-25 16:05:13', 'Всем прывет', 'not_started', NULL),
(20, 23, 8150.00, 150.00, 'processing', 'Курья', '+7 (822) 585-22-33', '2025-04-15 05:48:32', '2025-05-09 18:25:04', 'У меня нет дома', 'not_started', NULL),
(21, 20, 1050.00, 150.00, 'delivering', 'Лоскутова 20', '+7 (982) 258-52-23', '2025-05-09 05:50:06', '2025-05-25 16:20:45', 'Домофон ен работает', 'not_started', 23),
(22, 20, 6150.00, 150.00, 'completed', 'бла бла', '+7 (982) 258-52-23', '2025-05-09 06:24:44', '2025-05-25 15:11:23', 'Всем прывет', 'not_started', NULL),
(23, 20, 11650.00, 600.00, 'completed', 'Рублевка', '+7 (777) 777-77-77', '2025-05-09 06:36:10', '2025-05-25 15:02:38', 'я крутой', 'not_started', NULL),
(24, 23, 6850.00, 150.00, 'completed', 'Курья дом родной', '+7 (952) 651-18-78', '2025-05-09 18:30:36', '2025-05-25 15:00:56', 'Домофон не работает', 'not_started', NULL),
(25, 20, 36650.00, 1350.00, 'delivering', 'ПГНИУ', '+7 (534) 907-82-34', '2025-06-01 11:43:51', '2025-05-25 16:24:59', 'Положить приборы на всю группу', 'not_started', 23),
(26, 18, 2750.00, 150.00, 'completed', 'Александровск', '+7 (982) 258-52-23', '2025-02-12 12:33:57', '2025-05-11 12:35:54', 'Хочу пытсы', 'not_started', NULL);
...
(43, 25, 'processing', '2025-05-25 13:20:53'),
(44, 25, 'processing', '2025-05-25 13:34:06'),
(45, 25, 'pending', '2025-05-25 13:34:08'),
(46, 25, 'processing', '2025-05-25 13:34:10'),
(47, 25, 'delivering', '2025-05-25 13:45:13'),
(48, 25, 'delivering', '2025-05-25 13:55:43'),
(49, 25, '', '2025-05-25 13:59:34'),
(50, 25, 'completed', '2025-05-25 13:59:38'),
(51, 25, 'processing', '2025-05-25 13:59:57'),
(52, 25, 'delivering', '2025-05-25 14:00:00'),
(53, 25, '', '2025-05-25 14:00:02'),
(54, 25, 'delivering', '2025-05-25 14:06:00'),
(55, 25, '', '2025-05-25 14:06:01'),
(56, 24, '', '2025-05-25 14:48:19'),
(57, 23, '', '2025-05-25 14:48:21'),
(58, 22, '', '2025-05-25 14:48:23'),
(59, 21, '', '2025-05-25 16:05:09'),
(60, 19, 'delivering', '2025-05-25 16:05:13'),
(61, 25, 'processing', '2025-05-25 16:24:40'),
(62, 25, '', '2025-05-25 16:24:42');
...
(23, 'Jonyxx', 'john@mail.ru', '$2b$10$dtz4GcHRs855aq9YIGObLeOppVX.EsnFmkfJUe4XiOxRVvt9BE1kq', 'courier', '2025-04-19 13:04:38'),
(25, 'Ivan', 'ivan@mail.ru', '$2b$10$lO5UPaSh62RO2Q.uLVzI7.hg.CSZNrCz6jvH9UchB/4y.PMboKQbO', 'admin', '2025-05-11 07:06:17');
...
--
-- Индексы таблицы `courier_deliveries`
--
...
--
-- AUTO_INCREMENT для таблицы `courier_deliveries`
--
ALTER TABLE `courier_deliveries`
...
--
-- Ограничения внешнего ключа таблицы `courier_deliveries`
--
ALTER TABLE `courier_deliveries`
  ADD CONSTRAINT `courier_deliveries_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  ADD CONSTRAINT `courier_deliveries_ibfk_2` FOREIGN KEY (`courier_id`) REFERENCES `users` (`id`);
